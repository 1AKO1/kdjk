<template>
	<view>
		<view class="content" @touchstart="hideDrawer" style="background: #FFFFFF;">
				...
				<view class="row" v-for="(row,index) in msgList" :key="index" :id="'msg'+row.msg.id">
					...
					<block v-if="row.type=='system'" >
						<view class="system">
							...
							<view v-if="row.msg.type=='redEnvelope'" class="red-envelope">
								<image src="../../static/imgs/red-envelope.png"></image>
								{{row.msg.content.text}}
							</view>
						</view>
					</block>
					...
					<block v-if="row.type=='user'">
						...
						<view class="my" v-if="row.msg.userinfo.uid==myuid">
							...
							<!-- 右-头像 -->
							<view class="right">
								<image src="../../static/imgs/th.jpg"></image>
							</view>
						</view>
						<!-- 别人发出的消息 -->
	...
	export default {
		data() {
			return {
				...
				msgImgList:[],
				myuid:0,
				msgImgURL:'../../static/imgs/nvdoctor.jpg',
				msgName:'',
				...
				hideEmoji:true,
				emojiList:[
					[{"url":"../../static/imgs/emoji/100.gif",alt:"[微笑]"},{"url":"101.gif",alt:"[伤心]"},{"url":"102.gif",alt:"[美女]"},{"url":"103.gif",alt:"[发呆]"},{"url":"104.gif",alt:"[墨镜]"},{"url":"105.gif",alt:"[哭]"},{"url":"106.gif",alt:"[羞]"},{"url":"107.gif",alt:"[哑]"},{"url":"108.gif",alt:"[睡]"},{"url":"109.gif",alt:"[哭]"},{"url":"110.gif",alt:"[囧]"},{"url":"111.gif",alt:"[怒]"},{"url":"112.gif",alt:"[调皮]"},{"url":"113.gif",alt:"[笑]"},{"url":"114.gif",alt:"[惊讶]"},{"url":"115.gif",alt:"[难过]"},{"url":"116.gif",alt:"[酷]"},{"url":"117.gif",alt:"[汗]"},{"url":"118.gif",alt:"[抓狂]"},{"url":"119.gif",alt:"[吐]"},{"url":"120.gif",alt:"[笑]"},{"url":"121.gif",alt:"[快乐]"},{"url":"122.gif",alt:"[奇]"},{"url":"123.gif",alt:"[傲]"}],
		...
		onLoad(option) {
			...
			this.msgImgURL = option.imgurl;
			this.msgName = option.name;
			console.log(option.imgurl)
			console.log(this.msgImgURL);
			this.getMsgList();
			//语音自然播放结束
		...
		methods:{
			...
			loadHistory(e){
				...
				setTimeout(()=>{
					// 消息列表
					let list = [
						{type:"user",msg:{id:2,type:"text",time:"15:20",userinfo:{uid:1,username:"口袋助手",face:"../../static/img/im/face/face_2.jpg"},content:{text:"您好，这里是口袋助手，很高兴有机会能为您的健康保驾护航！您有任何问题，皆可以在这里反馈，我们将会给您提供帮助。"}}},
						{type:"user",msg:{id:1,type:"text",time:"15:22",userinfo:{uid:0,username:"大黑哥",face:"/static/img/face.jpg"},content:{text:"你好，我最近总是头痛，伴随轻度耳鸣。"}}},
						{type:"user",msg:{id:2,type:"text",time:"15:23",userinfo:{uid:1,username:"口袋助手",face:"/static/img/im/face/face_2.jpg"},content:{text:"请问您最近的睡眠状况如何？"}}},
						{type:"user",msg:{id:2,type:"text",time:"15:20",userinfo:{uid:1,username:"口袋助手",face:"../../static/img/im/face/face_2.jpg"},content:{text:"您好，这里是口袋助手，很高兴有机会能为您的健康保驾护航！您有任何问题，皆可以在这里反馈，我们将会给您提供帮助。"}}},
						{type:"user",msg:{id:1,type:"text",time:"15:22",userinfo:{uid:0,username:"大黑哥",face:"/static/img/face.jpg"},content:{text:"你好，我最近总是头痛，伴随轻度耳鸣。"}}},
						{type:"user",msg:{id:2,type:"text",time:"15:23",userinfo:{uid:1,username:"口袋助手",face:"/static/img/im/face/face_2.jpg"},content:{text:"请问您最近的睡眠状况如何？"}}},
						{type:"user",msg:{id:2,type:"text",time:"15:20",userinfo:{uid:1,username:"口袋助手",face:"../../static/img/im/face/face_2.jpg"},content:{text:"您好，这里是口袋助手，很高兴有机会能为您的健康保驾护航！您有任何问题，皆可以在这里反馈，我们将会给您提供帮助。"}}},
			...
			getMsgList(){
				// 消息列表
				let list = [
					{type:"system",msg:{id:0,type:"text",content:{text:"2019-12-12 15:20"}}},
					// {type:"user",msg:{id:2,type:"text",time:"15:20",userinfo:{uid:1,username:"口袋助手",face:"/static/img/im/face/face_2.jpg"},content:{text:"您好，这里是口袋助手，很高兴有机会能为您的健康保驾护航！您有任何问题，皆可以在这里反馈，我们将会给您提供帮助。"}}},
					// {type:"user",msg:{id:1,type:"text",time:"15:22",userinfo:{uid:0,username:"大黑哥",face:"/static/img/face.jpg"},content:{text:"你好，我最近总是头痛，伴随轻度耳鸣。"}}},
			...
			sendMsg(content,type){
				...
				let content2=JSON.parse(content1);
				console.log(_self.textMsg)
				let msg1 = {type:'user',msg:{id:2,time:nowDate.getHours()+":"+nowDate.getMinutes(),type:type,userinfo:{uid:1,username:_self.msgName,face:"/static/img/im/face/face_2.jpg"},content:content2}}
				uni.request({
					url:'http://kdjk.c5ppc.cn/doctor_talk',
					data:{
						question:_self.textMsg,
						type:'word'
					},
					method:'POST',
					success:function(res){
						...
						// console.log(msg1.msg.content)
						msg1.msg.content.text='<div style="display: flex;align-items: center;word-wrap:break-word;">'+Msg+'</div>'
						setTimeout(function() {
							_self.screenMsg(msg1);
						}, 2000);
						// console.log(msg1)
					},
					fail:function(res){
			...
			sendVoiceMsg(content,type){
				...
				uni.uploadFile({
					...
					success: (data) => {
						var Msg = ''
					    var VoicesContent = JSON.parse(data.data)
						if(VoicesContent.code == 10000){
							Msg = VoicesContent.msg
						}else if(VoicesContent.code == 10010){
							Msg = VoicesContent.data
						}
						let msg1 = {type:'user',msg:{id:lastid,time:nowDate.getHours()+":"+nowDate.getMinutes(),type:'text',userinfo:{uid:1,username:_self.msgName,face:"/static/img/im/face/face_2.jpg"},content:{text:'<div style="display: flex;align-items: center;word-wrap:break-word;">'+Msg+'</div>'}}}
						setTimeout(function() {
							_self.screenMsg(msg1);
						}, 2000);
						console.log(VoicesContent)
			...
			startRecognize(e){
				...
				var _this = this
				_this.initPoint.Y = e.touches[0].clientY;
				_this.initPoint.identifier = e.touches[0].identifier;
				_this.RECORDER.start({format:"mp3"});
				var text = null
				var options = {}
				options.engine = 'iFly'
			...
			voiceIng(e){
				...
				//上滑一个导航栏的高度触发上滑取消发送
				if(this.initPoint.Y - touche.clientY>=uni.upx2px(0)){
					this.willStop = true;
			...
			recordEnd(e){
				var _self_ = this;
				// console.log(_self_.voiceContent);
				...
				if(!this.willStop){
					...
					msg.length = min+':'+sec;
					this.sendVoiceMsg(msg,'voice');
					
					console.log(msg)
					// this.sendVoiceMsg(_self_.voiceContent,'text')
